...
<html lang="ca">
  <head>
    ...
    <meta name="description" content="VoraStudio: Estudi creatiu a Girona especialitzat en disseny web, branding i estratègia digital. Impulsem la teva marca amb solucions innovadores i coherents." />
    
    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://vorastudio.cat/" />
    <meta property="og:title" content="VoraStudio | Estudi Creatiu a Girona" />
    <meta property="og:description" content="Estratègia, comunicació i disseny per construir marques amb criteri i coherència. Estudi creatiu a la vora del client." />
    <meta property="og:image" content="https://vorastudio.cat/img/og-image.jpg" />

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image" />
    <meta property="twitter:url" content="https://vorastudio.cat/" />
    <meta property="twitter:title" content="VoraStudio | Estudi Creatiu a Girona" />
    <meta property="twitter:description" content="Estratègia, comunicació i disseny per construir marques amb criteri i coherència. Estudi creatiu a la vora del client." />
    <meta property="twitter:image" content="https://vorastudio.cat/img/og-image.jpg" />

    <link rel="canonical" href="https://vorastudio.cat/" />
    ...
    <script type="application/ld+json">
    {
      ...
      "name": "VoraStudio",
      "image": "https://vorastudio.cat/img/logo.png",
      "description": "Estudi creatiu a Girona especialitzat en disseny web, branding i estratègia digital.",
      "address": {
        "@type": "PostalAddress",
    ...
    <link rel="apple-touch-icon" href="img/android-chrome-192x192.png?v=<?php echo time(); ?>" />

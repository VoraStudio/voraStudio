...
if (!$project) {
    header('Location: ../html/projectes.html');
    exit;
}
?><!doctype html>
<html lang="ca">
  <head>
    ...
    <title>VoraStudio | <?= ucfirst($project) ?></title>
  ...
  <body class="page-projecte" data-project="<?= $project ?>">
      <!-- ----- HEADER ----- -->
    ...
    <main class="main-projecte">
      <!-- SECCIÓN HERO (JS rellena) -->
      <section id="project-hero" class="project-hero"></section>

      <!-- SECCIÓN ESTRATEGIA (JS rellena) -->
      <section id="project-strategy" class="project-strategy"></section>

      <!-- SECCIÓN GALERÍA (JS rellena) -->
      ...
      <section class="projectes-scroll" id="projectes-scroll">
        <h2 class="projectes-scroll__heading">Projectes:</h2>
